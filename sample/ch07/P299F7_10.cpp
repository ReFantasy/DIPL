...
template <typename T>
std::vector<std::vector<T>> ConvHoriz(const std::vector<std::vector<T>> &src, double (*F)(int),
                                      int kern_size)
{
    int rows = src.size();
    int cols = src[0].size();
...
template <typename T>
std::vector<std::vector<T>> ConvVert(const std::vector<std::vector<T>> &src, double (*F)(int),
                                     int kern_size)
{
    int rows = src.size();
    int cols = src[0].size();
...
template <typename T>
std::vector<std::vector<T>> Vec2DAdd(const std::vector<std::vector<T>> &a,
...
double G0(int n)
{
    static std::vector<double> table = {0.23037781,  0.71484657, 0.63088076, -0.02798376,
