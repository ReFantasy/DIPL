...
namespace IPL
{
	...
	std::vector<std::vector<double>> NBSF(int rows, int cols, std::vector<double> D0s, std::vector<std::pair<int, int>> uv_ks, int n /*= 2*/)
	{
		...
		//		for (int j = 0; j < cols; j++)
		//		{
		//			double tmp = (1.0 / (1 + pow(D0 / Dk(i, j, uk, vk), 2 * n)))*(1.0 / (1 + pow(D0 / D_k(i, j, uk, vk), 2 * n)));
		//			vec_2d[i][j] = tmp;
		//		}
		//	}
		//	return vec_2d;
	...
	std::vector<std::vector<double>> NBPF(int rows, int cols, std::vector<double> D0s, std::vector<std::pair<int, int>> uv_ks, int n /*= 2*/)
	{
