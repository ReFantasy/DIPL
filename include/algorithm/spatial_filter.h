...
namespace IPL
{
     ...
     */
    std::vector<std::vector<double>> BlurArithmetic(
     ...
     *  \return the filtered image
     */
    std::vector<std::vector<double>> BlurGeometry(const std::vector<std::vector<double>> &src,
                                                  int kern_size);
     ...
     *  \return the filtered image
     */
    std::vector<std::vector<double>> BlurHarmonic(const std::vector<std::vector<double>> &src,
                                                  int kern_size);
     ...
     *  \return the filtered image
     */
    std::vector<std::vector<double>> BlurInverseHarmonic(
     ...
     *  \return the filtered image
     */
    std::vector<std::vector<double>> BlurMedian(const std::vector<std::vector<double>> &src,
                                                int kern_size);
     ...
     *  \return the filtered image
     */
    std::vector<std::vector<double>> BlurMaxMin(const std::vector<std::vector<double>> &src,
                                                int kern_size, int type = 0);
     ...
     *  \return the filtered image
     */
    std::vector<std::vector<double>> BlurMiddle(const std::vector<std::vector<double>> &src,
                                                int kern_size);
     ...
     *  \return the filtered image
     */
    std::vector<std::vector<double>> BlurModifiedAlpha(
        const std::vector<std::vector<double>> &src, int kern_size, int d);

    std::vector<std::vector<double>> NearestNeighborInterpolation(
