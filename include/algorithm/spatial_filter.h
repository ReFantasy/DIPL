...
namespace IPL
{
    ...
    PaddingImage(const std::vector<std::vector<double>>& src, int left, int right, int top, int bottom);
     ...
     */
    std::vector<std::vector<double>>
    BlurInverseHarmonic(const std::vector<std::vector<double>>& src, int kern_size, double Q);
     ...
     */
    std::vector<std::vector<double>>
    BlurMaxMin(const std::vector<std::vector<double>>& src, int kern_size, int type = 0);
     ...
     */
    std::vector<std::vector<double>>
    BlurModifiedAlpha(const std::vector<std::vector<double>>& src, int kern_size, int d);

    std::vector<std::vector<double>>
    NearestNeighborInterpolation(const std::vector<std::vector<double>>& src, int new_rows, int new_cols);
