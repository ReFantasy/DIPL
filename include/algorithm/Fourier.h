...
namespace IPL
{
    class Fourier
    {
      public:
        ...
        static vector<vector<complex<double>>> DFT(
            const vector<vector<complex<double>>> &array_in);

        // 功能 ：二维离散傅里叶逆变换
        // 参数 ：需要进行逆变换的二维复数向量
        // 输出 ：二维浮点数据向量，即傅里叶逆变换的结果
        static vector<vector<complex<double>>> IDFT(
            const vector<vector<complex<double>>> &array_in);
         ...
         */
        static vector<vector<complex<double>>> FFT(
            const vector<vector<complex<double>>> &array_in);
         ...
         *  \return two-dimensional complex vector
         */
        static vector<vector<complex<double>>> IFFT(
            const vector<vector<complex<double>>> &array_in);
    };
