...
namespace IPL
{
    ...
    public:
        ...
        cv::Mat operator()(const cv::Mat& src, const vector<vector<double>>& gauss, int ft_type = 0);
    ...
    private:
        ...
        vector<vector<std::complex<double>>> filter(const vector<vector<std::complex<double>>>& fourier,
